...
namespace Microsoft.Quantum.Samples
{
    ...
    class Program
    {
        static async Task Main()
        {
            ...
            // data file.
            var data = await LoadData("training_data7.json");
            ...
            {
                new [] {5.178546977088077,2.391063647437503,0.58},//0.2575, 0.581},//   4.037552, 1.63698  }, //3.00522},  //2.03083,  0.63527,  1.03771, 1.27881, 4.10186,  5.34396},
                new [] {10.586514,0.5 , 0.2575}, //2.92517,  1.14616}, //3.371623}, //0.860791, 2.92517,  1.14616, 2.99776, 2.26505,  5.62137},
                new [] {5.21662,2.5000, 1.000, 1.53913,  1.64524 },  //6.04363}  //0.224184, 1.53913,  1.64524, 4.79508, 1.49742,  1.5455}
            };
